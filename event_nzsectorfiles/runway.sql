...
CREATE TABLE `runway` (
  ...
  `Rwy1Ext` int(11) NOT NULL DEFAULT 0,
  `Rwy2Ext` int(11) NOT NULL DEFAULT 0,
  `Tick1Int` int(11) NOT NULL DEFAULT 0,
  `Tick2Int` int(11) NOT NULL DEFAULT 0,
...
) ENGINE=InnoDB AUTO_INCREMENT=4906 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
